...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActions()
    {
        UnityEngine.Debug.Assert(!m_GameCamera.enabled, "This will cause a leak and performance issues, InputActions.GameCamera.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_GameClick.enabled, "This will cause a leak and performance issues, InputActions.GameClick.Disable() has not been called.");
    }
